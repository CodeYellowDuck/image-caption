...
def parse_arguments() -> Namespace:
    ...
    parser.add_argument(
        "--json_train",
        type=str,
        default="/root/autodl-tmp/annotations/captions_train2017.json",
        help="Directory have MS COCO annotations file for the train split.")

    parser.add_argument(
        "--json_val",
        type=str,
        default="/root/autodl-tmp/annotations/captions_val2017.json",
        help="Directory have MS COCO annotations file for the val split.")

    parser.add_argument(
        "--image_train",
        type=str,
        default="/root/autodl-tmp/train2017",
        help="Directory have MS COCO images files for the train split.")

    parser.add_argument(
        "--image_val",
        type=str,
        default="/root/autodl-tmp/val2017",
        help="Directory have MS COCO image files for the val split.")

    parser.add_argument(
        "--output_dir",
        type=str,
        default="/root/autodl-tmp/mscoco_h5",
        help="Directory to save the output files.")

    parser.add_argument("--vector_dir",
                        type=str,
                        default="/root/autodl-tmp/image_captioning_with_transformers-main/glove",
